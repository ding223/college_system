...
function jinting(){
    ...
    table.on('tool(majorList)', function (obj) {
        ...
        if (layEvent === 'detail') { //查看
            ...
            showMajorInfo(data.mid,data.mname,data.credit,data.lifeyear,data.introduction,data.cid);
...
//查看专业信息
function showMajorInfo(majorId,majorMname,majorCredit,majorLifeyear,majorIntroduction,majorCid){
    alert("专业编号："+majorId+"\n专业名称："+majorMname+
        "\n学分制："+majorCredit+"\n学年制："+majorLifeyear+"\n专业介绍："+majorIntroduction+"\n学院编号："+majorCid)
}
//编辑专业信息
